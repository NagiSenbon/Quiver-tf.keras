...
from quiver_engine.util import (decode_predictions, get_evaluation_context,
                                get_input_config, load_img, safe_jsonify,
                                validate_launch)
...
def launch(model,
    ...
    html_base_dir = html_base_dir if html_base_dir is not None else dirname(
        abspath(__file__))
